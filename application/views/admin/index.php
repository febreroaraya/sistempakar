...
<tr>
<td colspan="3" height="10" align="center"><div style="color:#333333;"><iframe src="datetime_digital2.php" width=100% height=30 scrolling=no frameborder=0></iframe></div><font face="verdana" size="3" style="font-weight:bold;">&nbsp;LOGIN ADMIN</h3> <hr size="1" width="100%"/>
<?php
$log = isset($_GET['log']);
$logout = isset($_GET['logout']);
$reset = isset($_GET['reset']);
if($log=='1'){
echo '<div style=color:#336699; font-size: 15px; id=login_response>Silahkan Login untuk menuju halaman admin</div>';
} elseif($logout=='2'){
